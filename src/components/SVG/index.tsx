...
const SVG = ({type, className='', onClick}: { type: 'close'|'angle'|'dot', className?: string, onClick?:MouseEventHandler<SVGSVGElement> }) => {
    switch (type) {
        ...
        case 'angle':
            return (
                <>
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" className={className} onClick={onClick}>
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        case 'dot':
            return (
                <>
                    <svg xmlns="http://www.w3.org/2000/svg" width="3" height="4" viewBox="0 0 3 4" fill="none" className={className} onClick={onClick}>
