...
const TopBanner = () => {
    return (
        <div className={'bg-[#0B0B0B] whitespace-nowrap h-[54px] w-full flex overflow-hidden flex-row items-center justify-between'}>
            <img src={frame_desktop} className={'md:ml-2 md:left-0 relative left-[-65px]'} alt={'black friday gifts'}/>
            ...
            <div>
                <div className={'flex flex-row items-center justify-center'}>
                    <svg className={'block md:hidden mr-6 cursor-pointer'} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" className={'mr-[22px] ml-[14px] cursor-pointer hidden lg:block'}>
