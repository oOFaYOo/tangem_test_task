...
const BottomBanner = () => {
    return (
        <div className={'sm:w-[600px] h-[349px] min-w-[385px] grow overflow-hidden sm:rounded-2xl bg-gradient-to-b from-[#121212] via-[#070707] via-70% to-[#111111] flex flex-col justify-between items-center sm:items-end'}>
            <img className={'w-full h-full z-10 absolute sm:rounded-2xl sm:left-0 left-[-170px] min-w-[600px]'} src={frame}></img>
            <div className={'flex flex-row justify-end flex grow w-full pt-[15px] pr-[15px] z-20'}>
            ...
            <div className={'relative z-20 grow sm:w-[256px] float-right flex flex-col items-center justify-center sm:justify-end sm:ml-auto ml-[45px] sm:mr-[35px]'}>
                ...
                <span className={'text-white rounded-[14px] bg-white/10 text-[16px] tracking-[0.025px] leading-[17px] mb-[55px] px-[24px] py-[12px]'}>
                    {'Shop now '}
                    <span className={'sm:inline-block hidden'}>{'through Monday'}</span>
                </span>
            </div>
        </div>
    )
